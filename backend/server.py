...
QUOTES = [
    ...
    {"text": "Small steps every day beat big leaps once in a while.", "author": "Vibly"},
    {"text": "Your future self is watching you right now. Make them proud.", "author": "Unknown"},
    {"text": "Rest is not quitting. Rest is recharging.", "author": "Vibly"},
    {"text": "You are one habit away from a different life.", "author": "Unknown"},
    {"text": "Progress, not perfection.", "author": "Vibly"},
    {"text": "The version of you that you're becoming is worth the effort.", "author": "Unknown"},
    {"text": "Discipline is just choosing between what you want now and what you want most.", "author": "Unknown"},
    {"text": "Your only competition is who you were yesterday.", "author": "Vibly"},
    {"text": "Healing is not linear. Keep going anyway.", "author": "Unknown"},
    {"text": "Do it for the version of you that gave up too soon last time.", "author": "Vibly"},
    {"text": "You don't need motivation. You need a system.", "author": "Unknown"},
    {"text": "Good things take time. You're doing better than you think.", "author": "Vibly"},
    {"text": "One good decision leads to another. Start small.", "author": "Unknown"},
    {"text": "Your habits are quietly shaping your identity every single day.", "author": "Vibly"},
    {"text": "Tired? Rest. But don't quit.", "author": "Unknown"},
    {"text": "The best project you'll ever work on is you.", "author": "Vibly"},
    {"text": "Show up even when it's hard. Especially when it's hard.", "author": "Unknown"},
    {"text": "You're not behind. You're just on your own timeline.", "author": "Vibly"},
    {"text": "Today's effort is tomorrow's result.", "author": "Unknown"},
    {"text": "Be patient with yourself. Growth takes time.", "author": "Vibly"},
    {"text": "A bad day is not a bad life.", "author": "Unknown"},
    {"text": "You've survived 100% of your hard days so far.", "author": "Vibly"},
    {"text": "Don't wait to feel ready. Start, then get ready.", "author": "Unknown"},
    {"text": "Your health is a long game. Play it daily.", "author": "Vibly"},
    {"text": "Less perfection, more consistency.", "author": "Unknown"},
    {"text": "Even 1% better every day adds up to something incredible.", "author": "Vibly"},
    {"text": "You owe yourself the same love you give everyone else.", "author": "Unknown"},
    {"text": "The comeback is always stronger than the setback.", "author": "Vibly"},
    {"text": "Check in with yourself today. You matter.", "author": "Vibly"},
]
