    ...
    <div className="min-h-screen flex items-center justify-center bg-vibly-bg p-4" data-testid="auth-page">
      <div className="w-full max-w-md">
        <div className="text-center mb-8 animate-fade-in-up">
          <img src="/logo192.png" alt="Vibly" className="w-20 h-20 mx-auto rounded-2xl mb-4" />
          <h1 className="font-heading text-5xl font-black tracking-tight uppercase text-white">VIBLY</h1>
          <p className="text-vibly-accent mt-2 font-body tracking-widest text-sm font-bold uppercase">Track it. Feel it. Vibly.</p>
        </div>
